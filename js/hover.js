...
const trigger = '<div class="trigger"></div>';
$("body").append(trigger);
...
var hoverEffect = function(opts) {
    ...
    var trigger = opts.trigger || console.warn("no trigger");
    ...
    renderer.setSize(cW, parent.offsetHeight);
    ...
    $('.trigger').css('width',$(window).width()/2+'px');
    $('.trigger').css('height',$(window).height()+'px');
    $('.trigger').css('left',0+'px');
    $('.trigger').css('right','inherit');

    var swapSides = function(){
        let temp = $('.trigger')[0].style.left;
        $('.trigger')[0].style.left = $('.trigger')[0].style.right;
        $('.trigger')[0].style.right = temp;
    };
    ...
    var addEvents = function(){
        ...
        trigger.addEventListener(evtIn, function(e) {

            if($('.trigger')[0].style.left == "0px"){
